# FILE: recruiter_outreach/followup/scheduler.py
...
Rows due for a follow-up can be sitting at different sequence_steps, so
they're grouped by their next step and sent in separate batches — each
batch picks up the matching followup_<N>.md template.
"""

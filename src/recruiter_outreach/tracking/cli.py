# FILE: src/recruiter_outreach/tracking/cli.py
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Check inbox for bounces/replies/unsubscribes.")
    parser.add_argument("--since-days", type=int, default=14, help="How far back to scan (default: 14)")

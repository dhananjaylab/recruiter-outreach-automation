# FILE: src/recruiter_outreach/reporting/report.py

"""Run-level reporting: aggregates per-recruiter outcomes into a summary
and an exportable CSV, including a per-domain breakdown so patterns like
'every @company.com send failed' are easy to spot."""
